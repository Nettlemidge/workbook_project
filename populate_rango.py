import os
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'workbook_project.settings')
...
def populate():
    ...
    add_page(cat=python_cat, title="Learn Python in 10 Minutes", url="http://docs.python.org/2/tutorial/")

    django_cat = add_cat("Django", 64, 32)
    add_page(cat=django_cat, title="Official Django Tutorial", url="https://docs.djangoproject.com/en/1.9/intro/tutorial01/")
    ...
    add_page(cat=other_cat, title="Bottle", url="http://bottlepy.org/docs/dev/")
    add_page(cat=other_cat, title="Flask", url="http://flask.pocoo.org")
